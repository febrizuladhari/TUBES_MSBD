                                    ...
                                    <div class="modal-header">
                                        <form class="container-fluid my-5">
                                            ...
                                            <div class="modal-footer">
                                                ...
                                                <a href="{{ route('itemadmin') }}"> <button type="button" class="btn btn-primary">Search</button></a>
                                            </div>
                                        </form>
                                    </div>
                                </div>
                    ...
                    <div class="col-md-6 col-lg-3 mb-4">
                        <div class="card text-center">
                            <div class="card-body">
                                ...
                                <h5 class="d-block mb-1">Approve Damaged to Repaired</h5>
        ...
        <div class="row">
            <div class="col-lg-6 mb-4 order-0">
                <div class="card">
                    ...
                    <script>
                        var chart1 = document.getElementById('chartKategori');

                        var labels1 =  {{ Js::from($labels1) }};
                        var kategoris =  {{ Js::from($data1) }};
