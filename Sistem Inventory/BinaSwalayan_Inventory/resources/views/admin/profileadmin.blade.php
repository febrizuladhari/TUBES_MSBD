                ...
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        <div class="d-flex align-items-start align-items-sm-center gap-4">
                            <img src="{{ asset('img/avatars/admin.png') }}" alt="user-avatar" class="d-block rounded" height="100" width="100" id="avatar"/>
                        </div>
                    </div>
                    <hr class="my-0" />
                    <div class="card-body">
                        <form method="POST" action="{{ route('profile.update') }}">
                            ...
                            <div class="mt-2">
                                ...
                                <a href="/homeadmin"><button type="button" class="btn btn-outline-secondary">Back</button></a>
                            </div>
                        </form>
                    </div>
                </div>
