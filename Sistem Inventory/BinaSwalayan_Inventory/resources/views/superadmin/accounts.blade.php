...
@section('title')
    <title>Accounts- Superadmin</title>
@endsection
        ...
        <div class="container-xxl flex-grow-1 container-p-y">
            ...
            <div class="row my-4">
                <div class="d-grid gap-2 mx-auto">
                    <a href="{{ route('register') }}"><button class="btn btn-primary btn-lg" type="button"><i class='bx bx-user-plus bxs-like bx-tada-hover me-3'></i>Add New Account</button></a>
                </div>
            </div>
