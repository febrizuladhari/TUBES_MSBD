    ...
    <div class="container-fluid">
        ...
        <div class="row mb-2">
            ...
            <div class="col-6 d-flex justify-content-end">
                <a href="{{ route('register_account') }}">
                    <button class="btn btn-primary btn-lg" type="button"><i class='bx bx-user-plus bxs-like bx-tada-hover me-3'></i>Add New Account</button>
                </a>
            </div>
        </div>
