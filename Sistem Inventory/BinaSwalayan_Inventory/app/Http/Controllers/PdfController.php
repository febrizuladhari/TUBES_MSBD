...
class PdfController extends Controller
{
    ...
    public function cetakLaporanRusak()
    {
        ...
        $this->fpdf->Cell(130,6,'Item',1,0,'C');
        ...
        $this->fpdf->Cell(130,6,$hasil->nama_barang,1,0,);
    ...
    public function cetakListBarang()
    {
        ...
        $this->fpdf->Cell(50,6,'Supplier',1,0,'C');
        ...
        foreach ($hasils as $hasil){
        $this->fpdf->Cell(15,6,$hasil->id,1,0,'C');
        $this->fpdf->Cell(130,6,$hasil->Nama,1,0,);
        ...
        $this->fpdf->Cell(50,6,$hasil->Supplier,1,0);
