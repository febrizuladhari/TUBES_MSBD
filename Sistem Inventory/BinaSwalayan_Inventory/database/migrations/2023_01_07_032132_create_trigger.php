...
class CreateTrigger extends Migration
{
    ...
    public function up()
    {
        ...
        DB::unprepared('CREATE TRIGGER log_delete_supplier AFTER DELETE ON suppliers
        FOR EACH ROW
        BEGIN
        ...
        DB::unprepared('CREATE TRIGGER log_update_supplier BEFORE UPDATE ON suppliers
        FOR EACH ROW
        BEGIN
            INSERT INTO log_update_suppliers SET id_supplier = old.id,
                        nama_supplier_new = new.nama, nama_supplier_old = old.nama, updated_at = now();
        END
        ');
    ...
    public function down()
    {
        ...
        DB::unprepared('DROP TRIGGER IF EXISTS log_delete_gudang');
        DB::unprepared('DROP TRIGGER IF EXISTS log_delete_kategori');
        DB::unprepared('DROP TRIGGER IF EXISTS log_delete_outlet');
        DB::unprepared('DROP TRIGGER IF EXISTS log_delete_rak');
        DB::unprepared('DROP TRIGGER IF EXISTS log_delete_supplier');
        DB::unprepared('DROP TRIGGER IF EXISTS log_update_barang');
        DB::unprepared('DROP TRIGGER IF EXISTS log_update_user');
        DB::unprepared('DROP TRIGGER IF EXISTS log_update_gudang');
        DB::unprepared('DROP TRIGGER IF EXISTS log_update_kategori');
        DB::unprepared('DROP TRIGGER IF EXISTS log_update_outlet');
        DB::unprepared('DROP TRIGGER IF EXISTS log_update_rak');
        DB::unprepared('DROP TRIGGER IF EXISTS log_update_supllier');
    }
}
